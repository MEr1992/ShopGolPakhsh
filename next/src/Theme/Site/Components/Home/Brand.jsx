						...
						<div className="col-lg-4 col-md-4 col-sm-12 text-md-center m-b30 wow fadeInUp" data-wow-delay="0.2s">	
							<a className="icon-button d-md-inline-block d-none" href="blog-tag.html">
								<div className="text-row word-rotate-box c-black border-secondary bg-secondary">
									<span className="word-rotate">partner - partner - </span>
							...
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo1.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo2.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo3.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo4.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo5.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo6.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo7.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
								<a href="javascript:void(0);" className="companies-wrapper">
									<div className="companies-media">
										<img src={`${assetsPath}/pixio/images/companies/logo8.png`} alt="" /> 
									</div>
								</a>
							</div>
							<div className="item">
