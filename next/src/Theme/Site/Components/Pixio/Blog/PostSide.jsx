export const PostSide = () => {
    return(
        <>
            ...
            {/* Banner Start */}
                <div class="dz-bnr-inr bg-secondary overlay-black-light" style={{backgroundImage:`url(images/background/bg1.jpg)`}}>
                    <div class="container">
                        <div class="dz-bnr-inr-entry">
                            ...
                            <nav aria-label="breadcrumb" class="breadcrumb-row">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Post Side</li>
                                </ul>
                            </nav>
                        </div>
                    </div>	
                ...
                <section class="content-inner-1 z-index-unset">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 col-xl-6 mb-xl-0 mb-4"> 
                                <div class="corner-media">
                                    <img src="images/blog/blogpost-1/pic2.png" alt="" class="rounded"/>
                                </div>
                            </div>
                            <div class="col-12 col-xl-6">
                                ...
                                <div class="dz-blog blog-single style-1 sidebar">
                                    ...
                                    <div class="dz-meta">
                                        <ul>
                                            <li class="post-date">17 May 2024</li>
                                            <li class="dz-user">
                                        ...
                                        <div class="col-lg-6 col-md-6 m-b30">
                                            <div class="dz-card style-5">
                                                ...
                                                <div class="dz-info">
                                                    <div class="dz-meta">
                                                        <ul>
                                                            <li class="post-date">20 Apr 2024</li>
                                                        </ul>
                                                    </div>
                                                    <h4 class="dz-title">
                                                        <a href="blog-grid-right-sidebar.html">Trendsetter Chronicles: Unveiling the Latest in Fashion</a>
                                                    </h4>
                                                    <a href="blog-grid-right-sidebar.html" class="font-14 read-btn">Read More 
                                        ...
                                        <div class="col-lg-6 col-md-6 m-b30">
                                            <div class="dz-card style-5">
                                                ...
                                                <div class="dz-info">
                                                    <div class="dz-meta">
                                                        <ul>
                                                            <li class="post-date">10 June 2024</li>
                                                        </ul>
                                                    </div>
                                                    <h4 class="dz-title">
                                                        <a href="blog-grid-right-sidebar.html">Runway Rundown: Decoding Fashion Week’s Best Looks</a>
                                                    </h4>
                                                    <a href="blog-grid-right-sidebar.html" class="font-14 read-btn">Read More 
                                                        <i class="icon feather icon-chevron-right"></i>
                                                    </a>
