                                            ...
                                            <div className="swiper-wrapper" id="lightgallery2">
                                                <div className="swiper-slide">
                                                    <div className="dz-media DZoomImage">
                                                        <a className="mfp-link lg-item" href="images/products/product-detail2/product1.png" data-src="images/products/product-detail2/product1.png">
                                                ...
                                                <div className="swiper-slide">
                                                    <div className="dz-media DZoomImage">
                                                        <a className="mfp-link lg-item" href="images/products/product-detail2/product2.png" data-src="images/products/product-detail2/product2.png">
                                                            <i className="feather icon-maximize dz-maximize top-left"></i>
                                                        </a>
                                                ...
                                                <div className="swiper-slide">
                                                    <div className="dz-media DZoomImage">
                                                        <a className="mfp-link lg-item" href="images/products/product-detail2/product3.png" data-src="images/products/product-detail2/product3.png">
                                                            <i className="feather icon-maximize dz-maximize top-left"></i>
                                                        </a>
