						...
						<div className="container-fluid clearfix d-lg-flex d-block">
							...
							<div className="header-nav w3menu navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
								<div className="logo-header logo-dark">
									<Link href={hrefMenus[0]}><img src={`${assetsPath}/pixio/images/logo.svg`} alt=""/></Link>
								</div>
												...
												<li className="side-left">
													<ul className="portfolio-nav-link">
														{subjects?.map((subject,index)=>{
															return(
																<li key={index}>
																	<Link href={`/${local}/blog?subject=${subject?.id}`}>
					...
					<div className="container">
						<form className="header-item-search">
							...
							<ul className="recent-tag">
								...
								<li><Link href="shop-list.html">Clothes</Link></li>
								<li><Link href="shop-list.html">UrbanSkirt</Link></li>
								<li><Link href="shop-list.html">VelvetGown</Link></li>
								<li><Link href="shop-list.html">LushShorts</Link></li>
							</ul>
						</form>
						<div className="row">
									...
									<div className="swiper-wrapper">
										<div className="swiper-slide">
											<div className="shop-card">
												...
												<div className="dz-content">
													<h6 className="title"><Link href="shop-list.html">SilkBliss Dress</Link></h6>
