...
export default function Dashboard() {
    ...
    return (
        <div className="container mx-auto m-8 bg-white p-4" style={{width:'1280px'}}>
            {/* Header */}
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 gap-4 mt-8">
                ...
                <div key={tool.id} className="flex flex-col items-center p-4 rounded-lg shadow-lg bg-white">
                    <img
